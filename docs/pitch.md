...
An optional LLM hook lets you wire up Claude, Codex, or a local model as a compass — not a player. The LLM sees your Ithaca and your daily receipt and tells you whether you're still sailing toward your goal or drifting. Example feedback: "you haven't touched the repo in four days — maybe take a walk and think about why," "this commit is cleanup, not progress — are you avoiding the hard part?," or "writing specs doesn't produce revenue — deploying the API does." It doesn't score for you. It doesn't play for you. It's the wise friend on the journey.
